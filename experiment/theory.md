...
Rate Limiting restricts the number of queries a user can execute within a defined time interval. Since inference attacks rely on repeatedly issuing similar or related queries, limiting query frequency significantly reduces the attacker’s ability to collect enough information to infer private data.
